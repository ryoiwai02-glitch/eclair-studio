...
2. Main language/framework:
3. Package manager/build tool:
4. Current pain point with AI coding agents:
5. What kind of tasks do you want agents to handle?
...
2. Dev/run command:
3. Test command:
4. Lint/format command:
5. Any command that should not be run:

## Boundaries

1. Files/folders that must not be changed:
2. Sensitive areas:
3. Are documentation-only patches acceptable?
4. Are small config/template patches acceptable?
